public class Exercise02 {
    ...
    public static void main(String[] args) {
        ...
        tenFavoriteFoods[0] = "CousCous";
        tenFavoriteFoods[1] = "squid ink";
        tenFavoriteFoods[2] = "Tajine";
        tenFavoriteFoods[3] = "Pizza";
        tenFavoriteFoods[4] = "Pasta";
        tenFavoriteFoods[5] = "Burger";
        tenFavoriteFoods[6] = "Chicken Wings";
        tenFavoriteFoods[7] = "Steak";
        tenFavoriteFoods[8] = "Fish";
        tenFavoriteFoods[9] = "Chocolate";
