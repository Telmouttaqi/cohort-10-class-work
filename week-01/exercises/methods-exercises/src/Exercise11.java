...
public class Exercise11 {
    ...
    public static void main(String[] args) {
        ...
        pillowCount = Integer.parseInt(readInt("How many pillows do you sleep with?: "));
    ...
    public static String readInt(String k){

        k = String.valueOf(Integer.parseInt(readString("Enter the number please !: ")));
